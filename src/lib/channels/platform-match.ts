 ...
 *
 * Channel-model reconciliation (UNIFY1): ReplyStack stores Facebook and Instagram as DISTINCT
 ...
 * (that was PostStack's single-`meta`-channel model, unused here). The only name difference is
