...
CREATE UNIQUE INDEX "conversations_channel_id_contact_id_key" ON "conversations" USING btree ("channel_id" uuid_ops,"contact_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "conversations_workspace_id_last_message_at_idx" ON "conversations" USING btree ("workspace_id" uuid_ops,"last_message_at" timestamp_ops);--> statement-breakpoint
CREATE INDEX "conversations_workspace_id_status_idx" ON "conversations" USING btree ("workspace_id" uuid_ops,"status" uuid_ops);--> statement-breakpoint
CREATE INDEX "channels_status_idx" ON "channels" USING btree ("status" enum_ops);--> statement-breakpoint
CREATE INDEX "channels_workspace_id_idx" ON "channels" USING btree ("workspace_id" uuid_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "channels_workspace_id_platform_id_key" ON "channels" USING btree ("workspace_id" text_ops,"platform_id" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "workspaces_slug_key" ON "workspaces" USING btree ("slug" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "users_email_key" ON "users" USING btree ("email" text_ops);--> statement-breakpoint
CREATE INDEX "contacts_workspace_id_idx" ON "contacts" USING btree ("workspace_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "contacts_workspace_id_last_interaction_at_idx" ON "contacts" USING btree ("workspace_id" timestamp_ops,"last_interaction_at" timestamp_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "contact_channels_channel_id_platform_sender_id_key" ON "contact_channels" USING btree ("channel_id" text_ops,"platform_sender_id" text_ops);--> statement-breakpoint
CREATE INDEX "contact_channels_contact_id_idx" ON "contact_channels" USING btree ("contact_id" uuid_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "tags_workspace_id_name_key" ON "tags" USING btree ("workspace_id" text_ops,"name" text_ops);--> statement-breakpoint
CREATE INDEX "audit_logs_workspace_id_created_at_idx" ON "audit_logs" USING btree ("workspace_id" timestamp_ops,"created_at" timestamp_ops);--> statement-breakpoint
CREATE INDEX "flows_workspace_id_status_idx" ON "flows" USING btree ("workspace_id" uuid_ops,"status" uuid_ops);--> statement-breakpoint
CREATE INDEX "flow_triggers_channel_id_type_is_active_idx" ON "flow_triggers" USING btree ("channel_id" enum_ops,"type" bool_ops,"is_active" enum_ops);--> statement-breakpoint
CREATE INDEX "messages_conversation_id_created_at_idx" ON "messages" USING btree ("conversation_id" timestamp_ops,"created_at" timestamp_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "messages_platform_message_id_key" ON "messages" USING btree ("platform_message_id" text_ops);--> statement-breakpoint
CREATE INDEX "flow_sessions_contact_id_status_idx" ON "flow_sessions" USING btree ("contact_id" uuid_ops,"status" uuid_ops);--> statement-breakpoint
CREATE INDEX "sequences_workspace_id_idx" ON "sequences" USING btree ("workspace_id" uuid_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "sequence_enrollments_sequence_id_contact_id_key" ON "sequence_enrollments" USING btree ("sequence_id" uuid_ops,"contact_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "broadcast_recipients_broadcast_id_status_idx" ON "broadcast_recipients" USING btree ("broadcast_id" uuid_ops,"status" uuid_ops);--> statement-breakpoint
CREATE INDEX "comment_logs_channel_id_idx" ON "comment_logs" USING btree ("channel_id" uuid_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "comment_logs_channel_id_platform_comment_id_key" ON "comment_logs" USING btree ("channel_id" text_ops,"platform_comment_id" text_ops);--> statement-breakpoint
CREATE INDEX "comment_logs_workspace_id_idx" ON "comment_logs" USING btree ("workspace_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "flow_versions_flow_id_version_idx" ON "flow_versions" USING btree ("flow_id" int4_ops,"version" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "flow_versions_flow_id_version_key" ON "flow_versions" USING btree ("flow_id" uuid_ops,"version" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "auto_reply_rules_channel_id_trigger_type_is_active_idx" ON "auto_reply_rules" USING btree ("channel_id" enum_ops,"trigger_type" bool_ops,"is_active" enum_ops);--> statement-breakpoint
CREATE INDEX "auto_reply_rules_workspace_id_is_active_idx" ON "auto_reply_rules" USING btree ("workspace_id" uuid_ops,"is_active" bool_ops);--> statement-breakpoint
CREATE INDEX "outbound_idempotency_expires_at_idx" ON "outbound_idempotency" USING btree ("expires_at" timestamp_ops);--> statement-breakpoint
CREATE INDEX "pending_approvals_workspace_id_status_idx" ON "pending_approvals" USING btree ("workspace_id" uuid_ops,"status" uuid_ops);--> statement-breakpoint
CREATE INDEX "revoked_tokens_expires_at_idx" ON "revoked_tokens" USING btree ("expires_at" timestamp_ops);--> statement-breakpoint
CREATE INDEX "rate_limit_counters_window_start_idx" ON "rate_limit_counters" USING btree ("window_start" timestamp_ops);--> statement-breakpoint
CREATE INDEX "rule_cooldowns_expires_at_idx" ON "rule_cooldowns" USING btree ("expires_at" timestamp_ops);--> statement-breakpoint
CREATE INDEX "workspace_members_user_id_idx" ON "workspace_members" USING btree ("user_id" uuid_ops);
*/